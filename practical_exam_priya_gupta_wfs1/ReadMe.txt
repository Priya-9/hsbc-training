...
3. Buisness Logic : "Implementation" Package containing logic to output records of each category.
4. Service : "Service" Package containing Service class.
5. View : conatins the main method to run the whole project.